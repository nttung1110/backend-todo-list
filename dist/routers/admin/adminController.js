...
exports.readListBoards = readListBoards;
exports.readBoard = readBoard;
exports.createBoard = createBoard;
exports.deleteBoard = deleteBoard;
exports.updateBoard = updateBoard;
exports.readListTasks = readListTasks;
...
function readListBoards(req, res) {
  return Board.findAll({
    where: {
      userID: req.params.uid
    },
    attributes: ['boardID', 'boardName', 'status', 'userID']
  }).then(boards => res.status(200).send(boards)).catch(error => res.status(400).send(error.message));
}

function readBoard(req, res) {
...
function readListTasks(req, res) {
  return Task.findAll({
    where: {
      boardID: req.params.boardID
    },

...
function adminRouters() {
  //list view users
  router.get('/api/admin/users', verifyAdmin, adminController.listUsers); //router.get();
  //CRUD User
  ...
  router.delete('/api/admin/:uid', verifyAdmin, adminController.deleteUser); //login

  router.get('/api/admin/login', verifyAdmin, adminController.loginAdmin); //CRUD tables
  ...
  router.delete('/api/admin/user/:uid/board/:boardID', verifyAdmin, validUser, adminController.deleteBoard); //CRUD tasks
